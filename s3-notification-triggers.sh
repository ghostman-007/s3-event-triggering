...
bucket_name="ssingh.1728-bucket"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="ssingh.1728@gmail.com"
...
aws s3 cp ./s3-notification-triggers.sh s3://"$bucket_name"/s3-notification-triggers.sh
...
aws sns publish \
  ...
  --message "Check for S3 bucket content for more details of newly added item."
